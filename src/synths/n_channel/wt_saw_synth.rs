...
pub struct WTSawSynth<const BUFSIZE: usize, const NCHAN: usize> {
    oscillator: WTSaw<BUFSIZE>,
...
impl<const BUFSIZE: usize, const NCHAN: usize> WTSawSynth<BUFSIZE, NCHAN> {
    pub fn new(sr: f32) -> Self {
        WTSawSynth {
            oscillator: WTSaw::new(100.0, 0.8, sr),
