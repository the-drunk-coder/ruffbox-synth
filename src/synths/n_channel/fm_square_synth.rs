...
pub struct FMSquareSynth<const BUFSIZE: usize, const NCHAN: usize> {
    oscillator: FMSquare<BUFSIZE>,
...
impl<const BUFSIZE: usize, const NCHAN: usize> FMSquareSynth<BUFSIZE, NCHAN> {
    pub fn new(sr: f32) -> Self {
        FMSquareSynth {
            oscillator: FMSquare::new(100.0, 0.4, 0.8, sr),
...
impl<const BUFSIZE: usize, const NCHAN: usize> Synth<BUFSIZE, NCHAN>
    for FMSquareSynth<BUFSIZE, NCHAN>
{
