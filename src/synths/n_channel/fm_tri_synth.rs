...
pub struct FMTriSynth<const BUFSIZE: usize, const NCHAN: usize> {
    oscillator: FMTri<BUFSIZE>,
...
impl<const BUFSIZE: usize, const NCHAN: usize> FMTriSynth<BUFSIZE, NCHAN> {
    pub fn new(sr: f32) -> Self {
        FMTriSynth {
            oscillator: FMTri::new(440.0, 0.5, sr),
