...
pub struct FMSawSynth<const BUFSIZE: usize, const NCHAN: usize> {
    oscillator: FMSaw<BUFSIZE>,
...
impl<const BUFSIZE: usize, const NCHAN: usize> FMSawSynth<BUFSIZE, NCHAN> {
    pub fn new(sr: f32) -> Self {
        FMSawSynth {
            oscillator: FMSaw::new(100.0, 0.8, sr),
