 ...
 */
pub struct BiquadHiPass<const BUFSIZE:usize> {
    // user parameters
    cutoff: f32,
    q: f32,
...
impl <const BUFSIZE:usize> BiquadHiPass<BUFSIZE> {
...
impl <const BUFSIZE:usize> MonoEffect<BUFSIZE> for BiquadHiPass<BUFSIZE> {
    // some parameter limits might be nice ... 
    fn set_parameter(&mut self, par: SynthParameter, value: f32) {
        match par {
